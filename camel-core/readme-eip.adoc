...
| link:src/main/docs/eips/contract-eip.adoc[Contract] +
`<contract>` | Declare input and/or output data type contract on the endpoint or processor
...
| link:src/main/docs/eips/inputType-eip.adoc[Input Type] +
`<inputType>` | Declare an input type on the endpoint or processor
...
| link:src/main/docs/eips/outputType-eip.adoc[Output Type] +
`<outputType>` | Declare an output type on the endpoint or processor
