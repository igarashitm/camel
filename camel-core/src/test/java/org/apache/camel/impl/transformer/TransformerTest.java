...
import org.apache.camel.model.transformer.BeanTransformerDefinition;
 ...
 */
public class TransformerTest extends ContextTestSupport {

    protected static final Logger LOG = LoggerFactory.getLogger(TransformerTest.class);
    ...
    public void testJavaTransformer() throws Exception {
        ...
        abcresult.whenAnyExchangeReceived(new Processor() {
            ...
            public void process(Exchange exchange) throws Exception {
                LOG.info("Asserting XOrderResponse -> BOrderResponse convertion");
                assertEquals(BOrderResponse.class, exchange.getIn().getBody().getClass());
            }
    ...
    public void testBeanTransformer() throws Exception {
        ...
        Exchange exchange = new DefaultExchange(context, ExchangePattern.InOut);
        exchange.getIn().setBody("name=XOrder");
        Exchange answerEx = template.send("direct:bean", exchange);
        if (answerEx.getException() != null) {
            throw answerEx.getException();
        }
        assertEquals("name=XOrderResponse", answerEx.getOut().getBody(String.class));
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("direct:abc")
                    ...
                    .inOut("direct:xyz")
                        .inputType(BOrder.class)
                        .outputType(BOrderResponse.class)
                    .to("mock:abcresult");
                ...
                context.getDataFormats().put("myJsonDataFormat", new MyJsonDataFormatDefinition());
                DataFormatTransformerDefinition dfdef = new DataFormatTransformerDefinition();
                dfdef.setRef("myJsonDataFormat");
                ...
                edef1.setTo("java:org.apache.camel.impl.transformer.TransformerTest$XOrder");
                EndpointTransformerDefinition edef2 = new EndpointTransformerDefinition();
                edef2.setUri("myxml:endpoint");
                edef2.setFrom("java:org.apache.camel.impl.transformer.TransformerTest$XOrderResponse");
                ...
                BeanTransformerDefinition bdef1 = new BeanTransformerDefinition();
                bdef1.setBeanType(MyOtherBean.class.getName());
                bdef1.setMethod("toXOrder");
                bdef1.setFrom("other:OtherXOrder");
                bdef1.setTo("java:org.apache.camel.impl.transformer.TransformerTest$XOrder");
                BeanTransformerDefinition bdef2 = new BeanTransformerDefinition();
                bdef2.setBeanType(MyOtherBean.class.getName());
                bdef2.setMethod("toOtherXOrderResponse");
                bdef2.setFrom("java:org.apache.camel.impl.transformer.TransformerTest$XOrderResponse");
    ...
    public static class MyTypeConverters implements TypeConverters {
        ...
        @Converter
        public BOrder toBOrder(AOrder aorder) {
            LOG.info("TypeConverter: AOrder -> BOrder");
            return new BOrder();
        }
        
        @Converter
        public XOrder toXOrder(BOrder border) {
            LOG.info("TypeConverter: BOrder -> XOrder");
            return new XOrder();
        }
        ...
        @Converter
        public BOrderResponse toBOrderResponse(XOrderResponse xres) {
            LOG.info("TypeConverter: XOrderResponse -> BOrderResponse");
            return new BOrderResponse();
        }
        
        @Converter
        public AOrderResponse toAOrderResponse(BOrderResponse bres) {
            LOG.info("TypeConverter: BOrderResponse -> AOrderResponse");
    ...
    public static class MyOtherBean {
        public XOrder toXOrder(String input) {
            assertEquals("name=XOrder", input);
            LOG.info("Bean: Other -> XOrder");
            return new XOrder();
        }
        public String toOtherXOrderResponse(XOrderResponse input) {
            LOG.info("Bean: XOrderResponse -> Other");
            return "name=XOrderResponse";
        }
    }
