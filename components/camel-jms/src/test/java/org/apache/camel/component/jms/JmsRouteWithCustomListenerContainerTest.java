...
public class JmsRouteWithCustomListenerContainerTest extends CamelTestSupport {
    ...
    public void testSendOrder() throws Exception {
        ...
        JmsEndpoint jmsEndpoint = getMandatoryEndpoint("jms:queue:inbox?messageListenerContainerFactory=#myListenerContainerFactory", JmsEndpoint.class);
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("jms:queue:inbox?messageListenerContainerFactory=#myListenerContainerFactory")
                    .to("mock:inbox")
